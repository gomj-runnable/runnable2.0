...
const props = defineProps<{
    data: { label: string; group?: string; kind?: string; rankdir?: string; meta?: Record<string, unknown> }
}>()
...
<template>
    <div
        class="px-3 pt-1.5 pb-1.5 pl-2.5 border border-neutral-700 border-l-[3px] rounded-md bg-neutral-950 text-xs flex flex-col gap-0.5 min-w-[120px]"
        :class="accentClass"
