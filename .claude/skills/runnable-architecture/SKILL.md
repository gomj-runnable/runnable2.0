...
- `app/assets/css/constant.css` : color-family, font, size, radius, effect 같은 공통 디자인 토큰
- `app/assets/css/main.css` : 전역 엔트리 CSS
- `app/assets/css/map.css` : 지도 전용 semantic 변수와 지도 전역 스타일
...
- 공통 디자인 규격은 `app/assets/css/constant.css`에 우선 정의한다.
