...
export class NotificationToneEnum extends EnumBase {
    static readonly SUCCESS = new NotificationToneEnum('success', '성공', 'green', 'i-lucide-check-circle')
    ...
    static readonly WARNING = new NotificationToneEnum('warning', '경고', 'orange', 'i-lucide-alert-triangle')
