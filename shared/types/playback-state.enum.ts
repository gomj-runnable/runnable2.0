...
export class PlaybackStateEnum extends EnumBase {
    ...
    get isStopped(): boolean {
        return this.key === 'stopped'
    }
    get isPlaying(): boolean {
        return this.key === 'playing'
    }
    get isPaused(): boolean {
        return this.key === 'paused'
    }
    ...
    static from(key: string): PlaybackStateEnum {
        return (
            EnumBase.fromKey<PlaybackStateEnum>(PlaybackStateEnum, key) ?? PlaybackStateEnum.STOPPED
        )
    }
}
