...
const props = withDefaults(
    defineProps<{
        ...
        subtitle?: string
        /** 역할 코드 — `shared/constants/roles.ts` ROLES 값. 관리자 진입 메뉴 노출 판정용. */
        role?: number | null
    }>(),
    {
        username: undefined,
...
const menuItems = computed(() => {
    ...
    accountGroup.push(
        { label: '프로필 편집', icon: 'i-lucide-user', onSelect: () => {} },
        { label: '설정', icon: 'i-lucide-settings', onSelect: () => {} }
    )
