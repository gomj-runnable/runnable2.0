import type { HourlyWeather, WeatherCondition, Pm10Grade } from '#shared/types/weather'
 ...
 */
export const pm10GradeToColor = (grade: Pm10Grade): string => Pm10GradeEnum.from(grade).color
