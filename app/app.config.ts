    ...
    ui: {
            ...
            compoundVariants: [
                {
                    color: 'white',
                    variant: 'outline',
                    class: 'bg-[var(--color-surface-soft)] ring-1 ring-[var(--color-border-subtle)] text-[var(--color-text-inverse)] placeholder:text-[var(--color-text-inverse-28)] focus:ring-1 focus:ring-[var(--color-focus-ring-soft)] shadow-none'
                }
            ]
        },
        ...
        modal: {
            slots: {
                ...
                content:
                    'bg-[var(--color-surface-elevated)] ring-1 ring-[var(--color-border-subtle)] shadow-2xl sm:rounded-2xl',
